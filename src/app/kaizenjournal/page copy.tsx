            ...
            <div className="sm:flex sm:items-center">
              <div className="sm:flex-auto">
                ...
                <p className="mt-2 text-sm text-gray-700">
                  Pour modifier ou annoter un point, faire un CLIQUE DROIT sur
                  la ligne désirée. La modification du fichier Excel
...
export default OldKaizenJournal;
