    ...
    <>
      <div>
            ...
            <nav className="flex flex-1 flex-col">
              <ul role="list" className="flex flex-1 flex-col gap-y-7">
                ...
                <li className="-mx-6 mt-auto">
                  <a
                    href="#"
                    className="flex items-center gap-x-4 px-6 py-3 text-sm font-semibold leading-2 text-gray-900 hover:bg-gray-50"
                  >
                    <svg
                    ...
                    <span aria-hidden="true">Sylvain Castonguay</span>
                  </a>
                </li>
              </ul>
            </nav>
        ...
        <div className="sticky top-0 z-40 flex items-center gap-x-6 bg-white px-4 py-4 shadow-sm sm:px-6 lg:hidden">
          ...
          <div className="flex-1 text-sm font-semibold leading-2 text-gray-900">
            Dashboard
          </div>
          <a href="#">
            <span className="sr-only">Your profile</span>
