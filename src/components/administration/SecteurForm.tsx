...
const SecteurForm = () => {
  ...
  const onSubmit = async (data: FieldValues) => {
    const secteurDto = data as SecteurDto;
    console.log("Submitted SecteurDto " + Boolean(Number(data.secteur.desuet)));
    const equipeId = secteurDto.secteur.equipe.id;

    secteurDto.secteur.desuet = getBooleanValue(data.secteur.desuet);
    secteurDto.sousSecteur.desuet = getBooleanValue(data.sousSecteur.desuet);
