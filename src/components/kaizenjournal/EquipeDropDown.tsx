...
const EquipeDropDown = () => {
  ...
  return (
    <Listbox
      value={activeEquipe}
      onChange={(value) => {
        console.log("on change gets called " + value);
        setActiveEquipeWithNumber(value);
      }}
    >
      {({ open }) => (
                      ...
                      <div className="flex flex-col">
                        ...
                        <p
                          className={classNames(
                            active ? "text-lime-200" : "text-gray-500",
                            "mt-2"
                          )}
                        >
