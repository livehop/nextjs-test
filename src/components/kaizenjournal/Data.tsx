        ...
        <thead>
          <tr>
            ...
            <th>
              ...
              {/* <div className='flex gap-1 items-center cursor-pointer' onClick={() => setCurrentSortOrder(SortOrder.Secteur)}>
                                Secteur{currentSortOrder === SortOrder.Secteur && <ArrowDownIcon className='h-4 w-4' />}
                            </div> */}
            </th>
            <th>
              <ColumnHeader
            ...
            >
              ...
              <ColumnHeader
                title="Fin Planfié "
                className={GetColoredTextClass(3)}
              />
              <ColumnHeader
                title="Complété "
                className={GetColoredTextClass(4)}
              />
            </th>
            <th
              scope="col"
        ...
        <tbody className="divide-y divide-gray-200 bg-white">
          {kaizenDocuments?.data.map((kaizen) => (
            <tr key={kaizen.id}>
              ...
              <td className="px-2 py-2 text-sm text-gray-500 max-w-[600px]  line-clamp-3 ">
