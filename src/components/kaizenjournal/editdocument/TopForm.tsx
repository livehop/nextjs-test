                            ...
                            <div className="mt-2">
                                ...
                                >
                                    {equipeStore.idValues.map((idValue) => (
                                        <option value={idValue.id} key={idValue.id} selected={idValue.value === editDocument?.equipe.nomEquipe}>{idValue.value}</option>
                                    ))}
                                </select>
                            </div>
                        </div>
                            ...
                            <div className="mt-2">
                                ...
                                >
                                    {secteurStore.idValues.map((idValue) => (
                                        <option value={idValue.id} key={idValue.id} selected={idValue.id === editDocument?.secteur.id}>{idValue.value}</option>
                                    ))}
                                </select>
                            </div>
                        </div>
