...
const SidePanel = ({ open, setOpen }: Props) => {
  ...
  const { equipes, loadMeta, secteurs, categories, sousCategories } =
    kaizenStore;
                ...
                <Dialog.Panel className="pointer-events-auto w-screen max-w-2xl">
                  <form className="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
                    <div className="flex-1">
                      ...
                      {/* Divider container */}
                      <div className="space-y-2 sm:space-y-0 sm:divide-y sm:divide-gray-200 sm:py-0 bg-red-100">
                        {/* Project name */}
                        <div className="px-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:space-y-0 py-2 bg-red-300">
                          <div>
                            <label
                          ...
                          <div className="sm:col-span-2">{currentDate}</div>
                        </div>
