...
const CategoryFilter = () => {
  const { categoryStore, searchStore } = useStore();
          ...
          <div className="flex flex-col space-y-4">
            <div className="m-0 mt-4 ml-4 flex items-center justify-start space-x-2">
              ...
              <input
                ...
                name="search"
                id="search"
                className="block w-32 rounded-md border-0 py-0.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6"
            ...
            {idValues.map((idValue) => (
              <div
                key={idValue.id}
                className="m-0 ml-4 flex items-center space-x-2"
              >
                <Checkbox
                  id={idValue.value}
            ...
            <div className="items-top flex space-x-2 mt-4"></div>
          </div>
        </PopoverContent>
      </Popover>
    </>
